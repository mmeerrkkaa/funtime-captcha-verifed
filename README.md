...
- **Автоматически решать капчу** - включить автоматическое распознавание через API
- **URL API** - адрес API сервера (по умолчанию: `http://212.22.70.39:5000/recognize`) ЭТО БЕСПЛАТНЫЙ СЕРВЕР ДЛЯ ПРОХОЖДЕНИЯ КАПЧ. ШАНС УСПЕХА 80%
